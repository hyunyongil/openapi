...
class DMM_page {
    ...
    private $configs = array(
        'total' => 'total ? rows',                 //?为占位符
        'pages' => 'total ? pages',               //页数信息，?为占位符
        'prev' => '&lsaquo;',
        'next' => '&rsaquo;',
        'first' => '&lsaquo;&lsaquo;',
        'last' => '&rsaquo;&rsaquo;',
     ...
     * @param int $countPerPage     每页显示数目, 默认为10条
     * @param array $configs   页面样式配置信息
     * @return void 
     */
    public function __construct($params) {
        /* 类属性的初始化 */
        $this->total = array_key_exists('total', $params) ? intval($params['total']) : 0;
        $this->countPerPage = array_key_exists('countPerPage', $params) ? $params['countPerPage'] : 10;
        $configs = array_key_exists('configs', $params) ? $params['configs'] : [];
